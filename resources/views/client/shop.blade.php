...
@section('content')
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('frontend/images/4.jpg');">
      <div class="container">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc"></span><span class="price-sale">BDT. {{$product->product_price}}</span></p>
		    					</div>
	    					</div>
